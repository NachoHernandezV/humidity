...
<?php
	...
	if($zona == 1)
	{
		...
		if($etapas=="Trigo al T1")  //	if($etapas=="Molienda")
		$tabla="molino1_molienda";

		if($etapas=="Harina")   //	if($etapas=="Envio")
		$tabla="molino1_envio";
	}
	...
	if($zona == 2)
	{
		...
		if($etapas=="Trigo al T1")   //	if($etapas=="Caída del Banco")
		$tabla="molino2_caidablanco";

		if($etapas=="Harina")     //if($etapas=="Molienda")
	...
	while ($valor = mysql_fetch_assoc($select)){
		$nombre_jugador = $valor['humedadMol'];
	}
