  ...
  function enviarDatos()
	{
			...
			cenizas = document.getElementById('cenizas');//fin
			...
			ajax.onreadystatechange = function() {
				...
				if (ajax.readyState == 4){
					...
					humedad.value = resultados[0];  //OBTENER LA PARTE 1
					cenizas.value = resultados[1];  //OBTENER LA PARTE 2
...
if(	$Editar == "Editar") //CUANDO SE PRESIONE EL BOTON DE EDITAR
{
		if($zona == "1" and $etapas=="Limpia") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino1_limpia SET humedadLab='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino1_limpia SET humedadLab='".$humedad."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino1_limpia')";
		...
		if($zona == "1" and $etapas=="Cambio") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino1_cambio SET humedadLab='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino1_cambio SET humedadLab='".$humedad."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino1_cambio')";
				 $resultad=mysqli_query($link,$sql2);
		}
		...
		if($zona == "1" and $etapas=="Trigo al T1") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino1_molienda SET humedadLab='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino1_molienda SET humedadLab='".$humedad."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino1_molienda')";
				 $resultad=mysqli_query($link,$sql2);
		}
		if($zona == "1" and $etapas=="Harina") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino1_envio SET humedadLab='100',cenizas='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino1_envio SET humedadLab='".$humedad."', cenizas='".$cenizas."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino1_envio')";
				 $resultad=mysqli_query($link,$sql2);
		}
		...
		if($zona == "2" and $etapas=="Limpia") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino2_limpia SET humedadLab='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino2_limpia SET humedadLab='".$humedad."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino2_limpia')";
				 $resultad=mysqli_query($link,$sql2);
		}

		if($zona == "2" and $etapas=="Trigo al T1") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino2_caidablanco SET humedadLab='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino2_caidablanco SET humedadLab='".$humedad."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino2_caidablanco')";
				 $resultad=mysqli_query($link,$sql2);
		}

		if($zona == "2" and $etapas=="Harina") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE molino2_molienda SET humedadLab='100',cenizas='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE molino2_molienda SET humedadLab='".$humedad."', cenizas='".$cenizas."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio molino2_molienda')";
				 $resultad=mysqli_query($link,$sql2);
		}
		...
		if($zona == "3" and $etapas=="Mezclas Continuas") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE mezclas_continuas SET humedadLab='100',cenizas='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE mezclas_continuas SET humedadLab='".$humedad."', cenizas='".$cenizas."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio mezclas_continuas')";
				$resultad=mysqli_query($link,$sql2);
		}
		...
		if($zona == "3" and $etapas=="Empaque") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE mezclas_empaque SET humedadLab='100',cenizas='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE mezclas_empaque SET humedadLab='".$humedad."', cenizas='".$cenizas."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio mezclas_empaque')";
				$resultad=mysqli_query($link,$sql2);
		}
		...
		if($zona == "3" and $etapas=="Envasado") //ZONA  MOLINO 1 Y LIMPIA
		{
				if($hayparo=='si')
				{
					$sql="UPDATE mezclas_envasado SET humedadLab='100',cenizas='100' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				else
				{
						$sql="UPDATE mezclas_envasado SET humedadLab='".$humedad."', cenizas='".$cenizas."' WHERE fecha='".$fecha."' and hora='".$horas."'";
				}
				 $resultad=mysqli_query($link,$sql);
				 $sql2="INSERT INTO editar (iduser,Hora,fecha,fechamovim,Tabla) VALUES ('$iduser','$horas','$fecha','$fechamovim','Laboratorio mezclas_envasado')";
				 $resultad=mysqli_query($link,$sql2);
		}
