...
<table>
	...
	<div align="center">
	<form action=index.php method=POST name="delet">
	<tr>
	<td ALIGN=center><a href="index.php" target="_top"><font size=2 face="Arial Black" color="red">Volver a la pagina principal</font></a>
	</td>
	</tr>
	</form>
	</div>
